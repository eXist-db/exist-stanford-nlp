...
// shadow-root
svg.style.cssText=cssText;svg.appendChild(content).removeAttribute("id");return svg}return null}});const IronSelection=function(selectCallback){this.selection=[];this.selectCallback=selectCallback};_exports.IronSelection=IronSelection;IronSelection.prototype={/**
...
setRootPath(MyAppGlobals.rootPath);class MyApp extends PolymerElement{static get template(){return html`
    ...
    `}static get properties(){return{page:{type:String,value:"./view1",reflectToAttribute:!0,observer:"_pageChanged"},routeData:Object,rootPath:{type:String,value:"/exist/apps/stanford-nlp/"},subroute:Object}}static get observers(){return["_routePageChanged(routeData.page)"]}_routePageChanged(page){// Show the corresponding page according to the route.
//
